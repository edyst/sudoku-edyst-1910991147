const easy = [
    "3-8----162-1756-----6--1972-3-41-2---89---1--15-38---476-5---2----642-85--5----69",
    "378924516291756843546831972637419258489265137152387694764598321913642785825173469"
  ];
  const medium = [
    "7---53----8-1---4---5------------------8--4311--4-59----8--97---923-8--4-6-------",
    "741953286983126547625784319834291675259867431176435928318649752592378164467512893"
  ];
  const hard = [
    "-2-5-78----74---6--5--6-4--38--15--6---8---3--1-32----------5---72--1-----------2",
    "4265378191974823658531694273897152462658947317143269586312785945729416839486531722"
  ];
var selectedCell;
...
function validate() {
   ...
   if(sum!=405){
    ...
    if(status==1){
        ...
        alert("Fill all the inputs before validating!");
       }   
}
function endGame() {
    sessionStorage.clear();
